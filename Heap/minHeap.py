...
# peeking (of the minimum / root value), as well as sifting a value up and down the
# heap and building the heap from an input array. The heap should be represented in the form of an array.
